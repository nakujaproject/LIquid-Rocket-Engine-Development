...
// setup "float calibrationFactor = 4.5;" for the PID nd sensors
...
void loop() {
   ...
   */
   ...
   /*
    ...
    // In bars
    JSONencoder["O_pressure"] = OxygenoutputValue;
    JSONencoder["N_pressure"] = NitrogenoutputValue;
    JSONencoder["O_flowrate"] = OxygenflowRate ;
    JSONencoder["N_flowrate"] = NitrogenflowRate;
